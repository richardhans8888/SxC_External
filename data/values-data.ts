...
// ── Image imports ──────────────────────────────────────────────
// Add your image files to /images/values/ and import them here.
// Replace these with your actual filenames.
import individualTeamImg from "@/images/values/individual-team.jpg";
import traditionInnovationImg from "@/images/values/tradition-innovation.jpg";
import passionAchievementImg from "@/images/values/passion-achievement.jpg";
import impactLegacyImg from "@/images/values/impact-legacy.jpg";
...
export const VALUES_DATA: ValueCardProps[] = [
  ...
  },
  {
    ...
    imageSrc: traditionInnovationImg,
  ...
  },
  {
    ...
    imageSrc: passionAchievementImg,
